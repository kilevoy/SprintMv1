...
| Window interface/profile data | 3 | 3 756 | локальные кандидаты и layout; расчёт ненулевых окон не разрешён |
| **Всего** | **22** | **102 416** | — |
...
Не включены как canonical:

- файл таблицы городов с совпадением около 82,4% с ID 3;
- `Подбор оконых ригелей v2.0.xlsx` вместо ID 4;
- неизвестные данные ID 5.
